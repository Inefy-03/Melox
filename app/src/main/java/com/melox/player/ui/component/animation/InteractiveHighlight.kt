...
/**
 * Draws a press-driven additive sheen. Drawing and gesture modifiers are separate so the sheen
 * can cover a recorded glass layer while its hit target remains on the moving indicator.
 */
internal class InteractiveHighlight(
    ...
    val modifier: Modifier = Modifier.drawWithContent {
        ...
        if (progress > 0f) {
            // Plus blending lifts the sampled luminance without replacing backdrop detail.
            drawRect(
